import { StandardAffix, CaseAccessorAffix, CaseStackingAffix, Lexicon, Root } from "./types.ts";
...
export async function bundle(): Promise<Lexicon> {
    return {
        ...
        affixes: {
            standard: (await readJsonFiles<StandardAffix[]>('./lexicon/affixes/standard')).flat(),
